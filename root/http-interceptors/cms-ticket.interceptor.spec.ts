...
class MockContentfulLauncherService {
...
describe('CmsTicketInterceptor', () => {
  ...
  let service: ContentfulLauncherService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: ContentfulLauncherService,
          useClass: MockContentfulLauncherService,
        },
        {
    ...
    service = TestBed.inject(ContentfulLauncherService);
